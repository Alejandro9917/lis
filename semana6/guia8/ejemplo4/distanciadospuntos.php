...
printf("<p class=\"resp\">D = √((x<sub>2</sub>-
x<sub>1</sub>)<sup>2</sup> + (y<sub>2</sub>-
y<sub>1</sub>)<sup>2</sup>)</p>\n");
printf("<p class=\"resp\">D = √((%5.2lf-%5.2lf)<sup>2</sup> +
(%5.2lf-%5.2lf)<sup>2</sup>)</p>\n", $coord2->x, $coord1->x,
$coord2->y, $coord1->y);
}
else{
?>
...
<div class="field">
<input type="number" name="coordx1" id="coordx1"
...
<div class="field">
<input type="number" name="coordy1" id="coordy2"
...
<div class="field">
<input type="number" name="coordx2" id="coordx2"
...
<div class="field">
<input type="number" name="coordy2" id="coordy2"
